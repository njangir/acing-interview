  ...
  return (
    <>
      ...
      <Alert className="mb-6 bg-primary/5 text-primary border-primary/20">
        ...
        <AlertDescription>
          This page demonstrates managing <strong>global</strong> availability. <br />
          <span className="block mt-2">
            <strong>For production:</strong> You may want to manage slots <strong>per service</strong> (which would require a service selector and a more complex Firestore structure, e.g., <code>serviceAvailabilities/&#123;serviceId&#125;/&#123;dateString&#125;</code>).
          </span>
          <span className="block mt-2">
            Changes here <strong>simulate</strong> saving to Firestore and also update the <code>AVAILABLE_SLOTS</code> mock constant for prototype-wide reflection.
          </span>
          <span className="block mt-2">
